...
clang -Wno-format-security -Wno-parentheses-equality -Wno-deprecated-declarations -Ic:\Users\jason\vcpkg\installed\x64-windows-static\include src\omni-c-stable-windows.c c:\Users\jason\vcpkg\installed\x64-windows-static\lib\gc.lib -o foo.exe
