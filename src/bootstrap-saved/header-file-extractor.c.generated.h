/* Automatically extracted prototypes from header-file-extractor.c */
...
__attribute__((warn_unused_result)) buffer_t* extract_structures_process_declarations(buffer_t* output, declarations_node_t* root);
