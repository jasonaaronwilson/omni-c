...
roci_record_fields_t* make_roci_record_fields(roci_symid_t record_symid,
                                              uint32_t length,
                                              roci_symid_t* symids) {
  roci_record_fields_t* result = cast(
      roci_record_fields_t*, malloc_bytes(sizeof(roci_record_fields_t)
                                          + sizeof(roci_symid_t) * length));
...
char* find_record_field_name(roci_record_fields_t* fields,
