...
////       char* enum_node_name = token_to_string(enum_node->name);
////       char* to_string_prefix = remove_type_suffix(enum_node_name);
////       char* enum_node_type_string = string_printf("enum %s",
/// enum_node_name); /       output = buffer_append_enum_to_string(output,
/// enum_node, to_string_prefix, / enum_node_type_string); /       output =
/// buffer_append_string_to_enum(output, enum_node, to_string_prefix, /
/// enum_node_type_string); /       */ /     } /   }
////
////   return output;
//// }
